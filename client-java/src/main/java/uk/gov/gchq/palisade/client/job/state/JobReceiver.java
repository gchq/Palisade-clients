...
public interface JobReceiver {
     ...
     */
    class Builder extends ImmutableJobReceiver.Builder { // empty
    }
     ...
     */
    static JobReceiver createJobReceiver(final UnaryOperator<Builder> func) {
     ...
     */
    default JobReceiver change(final UnaryOperator<Builder> func) {
