...
public interface JobDownload {
     ...
     */
    class Builder extends ImmutableJobDownload.Builder { // empty
    }
     ...
     */
    static JobDownload createDownload(final UnaryOperator<Builder> func) {
    ...
    default JobDownload change(final UnaryOperator<Builder> func) {
