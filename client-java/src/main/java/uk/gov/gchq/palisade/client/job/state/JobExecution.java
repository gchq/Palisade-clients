...
public interface JobExecution {
     ...
     */
    class Builder extends ImmutableJobExecution.Builder { // empty
    }
     ...
     */
    static JobExecution createJobExecution(final UnaryOperator<Builder> func) {
    ...
    default JobExecution change(final UnaryOperator<Builder> func) {
