...
/**
 * A {@link DownloadStartedEvent} is posted when a download has started
 * <p>
 * Note that the {@link DownloadStartedEvent} class is generated at compile
...
@Value.Immutable
@TupleStyle
public interface IDownloadScheduledEvent extends IDownloadEvent { // empty
}
