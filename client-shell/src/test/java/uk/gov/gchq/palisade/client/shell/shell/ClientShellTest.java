...
import uk.gov.gchq.palisade.client.internal.dft.DefaultQuery;
...
import uk.gov.gchq.palisade.client.internal.download.DownloadImpl;
...
class ClientShellTest {
    ...
    void testRead() {
        ...
        shell = new ClientShell(client, Map.of(), Map.of(mockToken, List.of(mockQueryItem)));
        shell.sessionState.set(mockSession);
        ...
        // When/Then
        assertThatIllegalArgumentException()
            .isThrownBy(() -> shell.read(mockToken, nonExistentResourceId))
